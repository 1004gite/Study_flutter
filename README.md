...
> <img src = "/captures/first.png" width="50%" height="50%">

### 로그인화면

> StreamBuilder를 사용하여 로그인 여부를 판단.
> 로그인 되어있다면 다음 페이지로 넘어감, 도중 로그아웃된다면 로그인 페이지로 넘어감.
> <img src = "/captures/login.png" width="50%" height="50%">
### Home

> FirebaseUser정보 이용
> <img src = "/captures/home.png" width="50%" height="50%">

### Search

> 계정에 상관없이 데이터베이스 내의 모든 게시물을 보여줌
> <img src = "./captures/search.png" width="50%" height="50%">

### Create

> 기기 내의 사진을 선택, 원하는 글을 적은 후 오른쪽 상단 버튼으로
> storage에 이미지 저장, 데이터베이스에 정보 저장
> <img src = "./captures/create.png" width="50%" height="50%">
> <img src = "./captures/create.png" width="50%" height="50%">
...
> <img src = "./captures/picked.png" width="50%" height="50%">

### Account

> Firebase의 간단한 쿼리문을 통한 해당 user의 게시물 개수 표시
> ![Account<img src = "./captures/account.png" width="50%" height="50%">
